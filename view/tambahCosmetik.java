...
public class tambahCosmetik extends javax.swing.JDialog {
     ...
     */
    public tambahCosmetik(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Tambah Produk Kosmetik");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(tambahCosmetik.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                tambahCosmetik dialog = new tambahCosmetik(new javax.swing.JFrame(), true);
